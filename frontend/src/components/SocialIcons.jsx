...
import {RiDribbbleFill, RiGithubFill, RiInstanceFill, RiLinkedinFill, RiTwitterXFill, RiYoutubeFill} from 'react-icons/ri'
const SocialIcons = () => {
  return (
    <div className='flex gap-6 pr-4'>
      <Link to={''} className='text-[#08d9d6] text-2xl hover:translate-y-1 transition-all duration-500'><RiYoutubeFill /></Link>
      <Link to={''} className='text-[#f08a5d] text-2xl hover:translate-y-1 transition-all duration-500'><RiInstanceFill /></Link>
      <Link to={''} className='text-[#ff2e63] text-2xl hover:translate-y-1 transition-all duration-500'><RiTwitterXFill /></Link>
